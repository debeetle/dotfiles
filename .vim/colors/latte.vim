...
let g:colors_name = 'latte'

hi Normal           guisp=NONE      guifg=#4C4F69   guibg=NONE      ctermfg=254     ctermbg=NONE  gui=NONE           cterm=NONE
" hi Normal           guisp=NONE      guifg=#4C4F69   guibg=#E0E0E0   ctermfg=254     ctermbg=235  gui=NONE           cterm=NONE
...
hi SpellBad         guisp=#D20F39   guifg=NONE      guibg=NONE      ctermfg=211     ctermbg=NONE gui=NONE      cterm=NONE
hi SpellCap         guisp=#df8e1d   guifg=NONE      guibg=NONE      ctermfg=223     ctermbg=NONE gui=NONE      cterm=NONE
hi SpellLocal       guisp=#1e66f5   guifg=NONE      guibg=NONE      ctermfg=117     ctermbg=NONE gui=NONE      cterm=NONE
hi SpellRare        guisp=#40A02B   guifg=NONE      guibg=NONE      ctermfg=151     ctermbg=NONE gui=NONE      cterm=NONE
hi SpellBad         guisp=#D20F39   guifg=NONE      guibg=NONE      ctermfg=211     ctermbg=NONE gui=NONE      cterm=NONE
hi SpellCap         guisp=#df8e1d   guifg=NONE      guibg=NONE      ctermfg=223     ctermbg=NONE gui=NONE      cterm=NONE
hi SpellLocal       guisp=#1e66f5   guifg=NONE      guibg=NONE      ctermfg=117     ctermbg=NONE gui=NONE      cterm=NONE
hi SpellRare        guisp=#40A02B   guifg=NONE      guibg=NONE      ctermfg=151     ctermbg=NONE gui=NONE      cterm=NONE
