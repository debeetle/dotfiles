...
vim.o.ttimeoutlen = 8  -- ms to wait for a key code seq to complete


-- ================= Misc ================= --

vim.wo.wrap = false -- don't wrap long text into multiple lines
vim.o.history = 100 -- numbers of entries in history for ':' commands and search patterns (10000 = max)
